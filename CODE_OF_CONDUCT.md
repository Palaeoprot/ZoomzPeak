...
### A note specific to this community

This project sits at the meeting point of several fields — mass spectrometry,
archaeology, heritage science, data standards — whose conventions and vocabularies
differ. Contributors will regularly be expert in one half and non-expert in the
other. **Assume good faith across that gap.** A question that looks naive from
inside one discipline is usually a reasonable question from inside another, and
answering it well is how a shared standard gets built.

Archaeological material can also carry real sensitivities: human remains,
culturally significant objects, contested provenance, and unpublished excavation
data. Treat discussions touching these with the care they deserve, and respect
embargoes and the wishes of originating communities and institutions.
...
repository and the project Matrix room — and also applies when an individual is
